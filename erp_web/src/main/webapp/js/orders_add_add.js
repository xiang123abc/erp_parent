...
$(function(){
	/*$('#ordersgirdglass').datagrid({
		url:'glass.json',
		columns:[[ 
		          {field:'name',title:'玻璃类型',width:100,editor:{type:'text',options:{}}},
		          {field:'price',title:'单价',width:40,editor:{type:'numberbox',options:{precision:4}}},
		          {field:'num',title:'数量',width:40,editor:{type:'numberbox',options:{}}},
		          {field:'money',title:'金额',width:100,editor:{type:'numberbox',options:{precision:4}}},	  
...
function cal(){
    ...
    //计算金额
//    var money = num * price;
    var area = height * weight * num /1000000;
    //保留4位小数
    area = area.toFixed(4);
